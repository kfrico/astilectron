...
module.exports = {
    ...
    eventNames: {
        ...
        sessionCmdGetCookie: "session.cmd.get.cookie",
        sessionEventGetCookie: "session.event.get.cookie",
        sessionEventChangedCookie: "session.event.changed.cookie",
        ...
        windowCmdWebContentsExecuteJavascriptV2: "window.cmd.web.contents.execute.javascriptv2",
